        ...
        >
            <div className="relative bg-black bg-opacity-50 p-4 rounded m-4 text-end flex flex-col items-end">
                ...
                <div className="flex flex-row justify-end items-center">
                    <Image src="./about-marker.svg" alt="marker icon" height={20} width={20}></Image>
                    <div className="text-2xl px-2">{actuality.place}</div>
                    <div className="text-2xl pl-4">{actuality.date}</div>
                </div>
                <button className="my-4 text-purple bg-white rounded-md py-2 px-4 font-medium flex flex-row items-center"><div className="pr-2">Více zde</div> <Image src="./Vector.svg" alt="link icon" width={8} height={8}></Image></button>
            </div>
        </div>
    );
}
