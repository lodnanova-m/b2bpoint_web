                    ...
                    <ul className="flex items-center justify-center md:justify-start [&_li]:mx-6 [&_img]:max-w-none animate-infinite-scroll" key={index}>
                        ...
                        <li>
                            <Link href="http://www.patent-k.cz/">
                                <div className="text-blue text-2xl font-bold text-nowrap">Ing. Václav Kratochvíl,
                                </div>
                                <div className="text-blue text-2xl font-bold text-nowrap"> patentový zástupce</div>
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link href="services/2">
                                <div className="text-blue text-xl font-bold text-nowrap">Kopp | Balení sypkých potravín</div>
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <div className="text-blue text-xl font-bold text-nowrap">BETINA spol. s.r.o.</div>
                        </li>
                        <li>
