        ...
        <div className="flex lg:flex-row lg:justify-evenly flex-col p-10">
          <div className="flex flex-col justify-between">
            <div className="flex flex-col lg:pb-4">
              <div className="font-avenir font-bold text-xl">PROVOZOVATEL</div>
          ...
          <div className="font-avenir">
            ...
            <div className="pb-4">
              <a
                className="flex flex-row content-center py-2 hover:underline"
                href="mailto:info@b2bpoint.cz"
              >
                <Image
                  src={envelope}
                  alt="evelope icon"
              ...
              <a
                className="flex flex-row content-center py-2 hover:underline"
                href="https://maps.app.goo.gl/nEYJwzz5ySdYSnDp9"
              >
                <Image
                  src={marker}
                  alt="marker icon"
            ...
            <div>
              ...
              <div className="pb-4">
                ...
                <div className="py-2 flex flex-row">
                  ...
                  <button
                    type="submit"
                    className="bg-green  rounded-md px-2 py-2 mx-2 bg-opacity-70 hover:bg-green hover:bg-opacity-90"
                  >
                    <Image
                      src={envelope}
